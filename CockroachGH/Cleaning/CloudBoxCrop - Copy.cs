...
namespace CockroachGH {
    public class CloudBoxCropSlow : GH_Component {

        public CloudBoxCropSlow()
  : base("CloudBoxCropslow", "CloudBoxCropslow",
      "CloudBoxCropslow",
      "Cockroach", "Crop") {
        }
        ...
        public override Guid ComponentGuid {
            get { return new Guid("98aaf1ed-7834-48c8-8fd6-edf88cd54ba2"); }
        }
